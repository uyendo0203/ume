  ...
  return (
    <div className="home">
      <div className="home__left">
        <div className="home__left-wrap" >
          <div className="logo text-center" >
            <h1 className="text-orange text-[50px] font-bold">
              UME
              {/* <img src="https://themihub.com/html/morex-demo/morex/assets/images/logo-light.png" alt="xxx" /> */}
            </h1>
          </div>
          <div className="menu pt-[40px]" >
            <ul className="menu__ul">
              <li className="menu__li active">
              ...
              <li className="menu__li">
                <a className="menu__a" href="/" ><span className="menu__span">
          ...
          <div >
            <p className=" dark:text-white mt-7">Developed with <span className="px-[3px] inline-block">
              <svg className="text-paragraph dark:text-white fill-[red]" xmlns="http://www.w3.org/2000/svg" width={18} height={15} viewBox="0 0 24 24" fill="currentColor" stroke="text-paragraph" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" /></svg></span>  <br />by  <span className="px-[3px]">UyenDo</span>© 2023</p>
          </div>
        </div>
            ...
            <div className="info">
              ...
              <div className="follow">
                <div className="follow__wrap ">
                  <span className="follow__text">Follow Me: </span>
